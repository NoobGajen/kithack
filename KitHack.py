...
#RE-modnified by: Gajendra Mahato
...
def info():
	...
	time.sleep(0.5)
	print("{0}[AUTOR]:{1} TechGajen\n\n").format(RED, DEFAULT)
	time.sleep(0.5)
	print("{0}[GITHUB]:{1} https://www.github.com/Techgajen\n\n").format(RED, DEFAULT)
	time.sleep(0.5)
	print("{0}[FACEBOOK]:{1} https://www.facebook.com/TechGajen\n\n").format(RED, DEFAULT)
	time.sleep(0.5)
	print("{0}[INSTAGRAM]:{1} https://www.instagram.com/TechGajen\n\n").format(RED, DEFAULT)	
	time.sleep(0.5)
	print("{0}[YOUTUBE]:{1} https://www.youtube.com/TechGajen\n").format(RED, DEFAULT)
	time.sleep(2.5)
	os.system('clear')
	banner()
